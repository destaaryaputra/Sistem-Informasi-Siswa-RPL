...
if (!function_exists('rate_limit_storage_key')) {
...
if (!function_exists('rate_limit_decode_attempts')) {
...
if (!function_exists('rate_limit_db_status')) {
...
if (!function_exists('rate_limit_db_register_failure')) {
...
if (!function_exists('rate_limit_db_clear')) {
...
if (!function_exists('ensure_rate_limit_table')) {
